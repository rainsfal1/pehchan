...
class PKBUploadedFile {
  const PKBUploadedFile({
    this.name,
    this.bytes,
    this.height,
    this.width,
  ...
  @override
  String toString() =>
      'PKBUploadedFile(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash,)';
  ...
  static PKBUploadedFile deserialize(String val) {
