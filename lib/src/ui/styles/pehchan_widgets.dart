...
class PKBButtonOptions {
  const PKBButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class PKBButtonWidget extends StatefulWidget {
  const PKBButtonWidget({
    super.key,
    required this.text,
  ...
  final PKBButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<PKBButtonWidget> createState() => _PKBButtonWidgetState();
}

class _PKBButtonWidgetState extends State<PKBButtonWidget> {
  bool loading = false;
